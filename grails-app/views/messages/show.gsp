...
<html>
    ...
    <body>
        ...
        <div id="show-messages" class="content scaffold-show" role="main">
            ...
            <f:display bean="messages" />
            <g:form resource="${this.messages}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.messages}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
