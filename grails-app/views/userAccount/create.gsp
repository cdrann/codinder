...
<html>
    ...
    <body>
        <a href="#create-userAccount" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-userAccount" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.userAccount}" method="POST">
                <fieldset class="form">
                    <f:all bean="userAccount"/>
                </fieldset>
